...
{
	public interface IEventProviderCS_bacsecretariat
	{
		//	handlers
	...
	public interface IEventProviderVB_bacsecretariat
	{
		//	handlers
	...
	public class eventclass_bacsecretariat : EventsAggregatorBase
	{
		//[Import(typeof(IEventProviderCS_bacsecretariat))]
		public IEventProviderCS_bacsecretariat EventProviderCS;

		//[Import(typeof(IEventProviderVB_bacsecretariat))]
		public IEventProviderVB_bacsecretariat EventProviderVB;

		public void CreateEvents()
        {
			EventProviderCS = new eventclassCS_bacsecretariat();
			if(appsettings.vbEvents != null)
			{
				Type eType = appsettings.vbEvents.GetType("runnerDotNet.runnerDotNet.eventclassVB_bacsecretariat");
				if(eType != null)
				{
					EventProviderVB = (IEventProviderVB_bacsecretariat)Activator.CreateInstance(eType);
				}
			}
        }

		public eventclass_bacsecretariat()
		{
			CreateEvents();
