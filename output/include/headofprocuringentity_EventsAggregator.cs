...
{
	public interface IEventProviderCS_headofprocuringentity
	{
		//	handlers
	...
	public interface IEventProviderVB_headofprocuringentity
	{
		//	handlers
	...
	public class eventclass_headofprocuringentity : EventsAggregatorBase
	{
		//[Import(typeof(IEventProviderCS_headofprocuringentity))]
		public IEventProviderCS_headofprocuringentity EventProviderCS;

		//[Import(typeof(IEventProviderVB_headofprocuringentity))]
		public IEventProviderVB_headofprocuringentity EventProviderVB;

		public void CreateEvents()
        {
			EventProviderCS = new eventclassCS_headofprocuringentity();
			if(appsettings.vbEvents != null)
			{
				Type eType = appsettings.vbEvents.GetType("runnerDotNet.runnerDotNet.eventclassVB_headofprocuringentity");
				if(eType != null)
				{
					EventProviderVB = (IEventProviderVB_headofprocuringentity)Activator.CreateInstance(eType);
				}
			}
        }

		public eventclass_headofprocuringentity()
		{
			CreateEvents();
