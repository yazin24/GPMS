...
{
	[Export(typeof(IEventProviderCS_bacsecretariat))]
	public class eventclassCS_bacsecretariat : IEventProviderCS_bacsecretariat
	{
...
int ID = values["PersonnelId"];
 ...
 values["SecretariatName"] = PersonnelName;
